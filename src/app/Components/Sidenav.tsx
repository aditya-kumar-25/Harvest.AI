...
const Sidenav: React.FC<SidenavProps> = ({ chatOpened, setChatOpened }) => {
  ...
  return (
    ...
    >
      ...
      {chatOpened && (
        <div className=" max-h-[82vh] overflow-y-auto mt-10">
          <div className="">
      ...
      {chatOpened && (
        <div className=" flex justify-between items-end px-1">
          <ReactTextareaAutosize
            className="border my-2 mx-2 rounded-md px-3  py-2  bg-transparent w-[97%] resize-none"
            placeholder="Type your query here..."
            maxRows={5}
          />
          <div className="mb-5 rounded-full bg-white text-black p-1">
            <FaArrowUp />
          </div>
        </div>
      )}
